...
function go() {
  ...
  return regeneratorRuntime.async(function go$(context$1$0) {
    while (1) switch (context$1$0.prev = context$1$0.next) {
      ...
      case 33:
        ...
        return new Promise(function (res) {
          ...
          exec('casperjs ' + __dirname + '/newbot.js ' + info.teamdomain + ' ' + info.email + ' ' + info.password + ' ' + info.botname, opts, function (code, o) {
            var token = o.split('|')[1];
            var slack = { slack: {} };
